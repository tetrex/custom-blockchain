...
func (h *Header) EncodeBinary(w io.Writer) error {
	...
	if err := binary.Write(w, binary.LittleEndian, &h.Nounce); err != nil {
		return err
	}
	return nil
}
...
func (h *Header) DecodeBinary(r io.Reader) error {
	...
	if err := binary.Read(r, binary.LittleEndian, &h.Nounce); err != nil {
		return err
	}
	return nil
}
...
type Block struct {
	...
	hash         types.Hash // casched version of the header hash
}
